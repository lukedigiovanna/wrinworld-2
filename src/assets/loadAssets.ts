...
async function loadAssets(gl: WebGLRenderingContext) {
    ...
    await Promise.all([
        ...
        loadImageAndTexture(gl, "rainbow_target", "assets/images/tiles/rainbow_target.png"),
        ...
        loadImageAndTexture(gl, "cursed_overlay", "assets/images/props/cursed_overlay.png"),
